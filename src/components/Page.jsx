        ...
        return (
        	<div className="page">
	            ...
	            <section className="share">
		            ...
		            <iframe className="twitter-share" frameBorder="0" scrolling="no" allowTransparency="true" src={'https://platform.twitter.com/widgets/tweet_button.26f01cfa05bff9af89657dcbd8f7b705.en.html#_=1424933515646&count=horizontal&dnt=true&lang=en&size=m&text='+shareTitle+'&url='+shareURI+'&via=legogris'} title="Tweet this" data-twttr-rendered="true" ></iframe>
	            </section>
            </div>
	        );
	    }
